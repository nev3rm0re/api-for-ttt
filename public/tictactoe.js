...
/***/ function(module, exports, __webpack_require__) {
	...
	var _axios = __webpack_require__(/*! axios */ 3);
	...
	var Square = function (_React$Component) {
	    ...
	    _createClass(Square, [{
	        ...
	        value: function render() {
	            ...
	            var playerIconClassName = void 0,
	                playerClassName = "";
	            ...
	            return _react2.default.createElement(
	                'button',
	                { className: "square " + playerClassName,
	                ...
	                _react2.default.createElement('i', { className: playerIconClassName })
	            );
	        }
	    }]);
	...
	var Board = function (_React$Component2) {
	    ...
	    _createClass(Board, [{
	        ...
	        value: function renderSquare(i) {
	            ...
	            return _react2.default.createElement(Square, { className: className,
	                player: this.props.cells[i],
	    ...
	    _createClass(Game, [{
	        ...
	        value: function makeMove() {
	            ...
	            var payload = {
	                ...
	                "method": "makeMove",
	                "params": {
	                    "boardState": [cells.slice(0, 3), cells.slice(3, 6), cells.slice(6, 9)],
	        ...
	        value: function render() {
	            ...
	            var playerClassName = this.state.currentPlayer == PLAYER1 ? "player-x" : "player-o";
	
	            var status = "Next player: " + this.state.currentPlayer;
	            return _react2.default.createElement(
	                'div',
	                { className: "game row " + playerClassName },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'board' },
	                        _react2.default.createElement(Board, { cells: this.state.cells, game: this.state, onClick: function onClick(i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./lib/axios */ 4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Axios = __webpack_require__(/*! ./core/Axios */ 7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isAbsoluteURL = __webpack_require__(/*! ./../helpers/isAbsoluteURL */ 24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(/*! ./utils */ 5);
	var normalizeHeaderName = __webpack_require__(/*! ./helpers/normalizeHeaderName */ 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(/*! ./../utils */ 5);
	var settle = __webpack_require__(/*! ./../core/settle */ 12);
	var buildURL = __webpack_require__(/*! ./../helpers/buildURL */ 15);
	var parseHeaders = __webpack_require__(/*! ./../helpers/parseHeaders */ 16);
	var isURLSameOrigin = __webpack_require__(/*! ./../helpers/isURLSameOrigin */ 17);
	var createError = __webpack_require__(/*! ../core/createError */ 13);
	var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(/*! ./../helpers/btoa */ 18);
	...
	module.exports = function xhrAdapter(config) {
	  return new Promise(function dispatchXhrRequest(resolve, reject) {
	    ...
	    if (utils.isStandardBrowserEnv()) {
	      var cookies = __webpack_require__(/*! ./../helpers/cookies */ 19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var enhanceError = __webpack_require__(/*! ./enhanceError */ 14);
